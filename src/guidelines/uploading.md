...
- Go to the "My Stuff" page (or click the folder icon) on Blockopolis' home page and click the 3 dots on any project, then click "Edit Project".
...
- You must use the Blockopolis Reupload API as it credits the creator of the project by adding a bubble with a link.
- You must credit the original creator by linking to the Scratch project.
...
For now, you are not currently allowed to have online chatting within your project.
